...
Auteur : KF48-YA0-227 · Version 1 · Frontend choisi : React, parce que je maîtrise mieux son écosystème et que le build est simple à documenter.
...
| Système | Générer le code de présence, assigner aléatoirement un relecteur, calculer la moyenne, bloquer un étudiant après 5 erreurs de code |
...
- Assignation automatique d’un relecteur.
...
| EF4 | L’étudiant est assigné à la relecture d’un pair | Quand un exercice est déposé, alors le système assigne un relecteur parmi les étudiants présents, différent de l’auteur | Must |
| EF5 | Le relecteur rend une note et un commentaire | Quand je soumets une note entière entre 0 et 20 et un commentaire, alors la relecture est enregistrée et l’exercice passe au statut RELU | Must |
...
| EF11 | L’étudiant relu voit sa note et son commentaire, sans le nom du relecteur | Quand je consulte mon exercice relu, alors je vois la note et le commentaire, mais pas l’identité du relecteur | Should |
...
| RG8 | Si le relecteur ne rend jamais sa relecture, l’exercice reste EN_ATTENTE | Q11 |
...
| Moyenne sans note | Q16 dit « moyenne des notes reçues » | Si aucune note reçue, la moyenne est null dans l’API | Une moyenne de 0 serait fausse. Le front affiche « — ». |
